...
class MoonPayService {
  ...
  async createBuyTransaction(
    ...
    const response = await fetch(
      `${this.baseUrl}/v3/currencies/${cryptoCurrency}/buy_quote?apiKey=${this.publicKey}&baseCurrencyCode=${fiatCurrency}&baseCurrencyAmount=${fiatAmount}&externalCustomerId=${externalCustomerId}&timestamp=${timestamp}&signature=${signature}`
    );
